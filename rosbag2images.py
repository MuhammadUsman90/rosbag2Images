...
def main():
    ...
    topics= list(bag.get_type_and_topic_info()[1].keys()) #all the topics info
    ...
    for i in range(0,len(list(bag.get_type_and_topic_info()[1].values()))):
        types.append(list(bag.get_type_and_topic_info()[1].values()))
    ...
    for topic, msg, t in bag.read_messages(topics=[args.image_topic]):
        # this is ti support compesed image
